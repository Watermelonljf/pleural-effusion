...
public class MailHelper{
        ...
        public void sendMail(String to,String code) throws Exception{
            ...
            //正文
            message.setContent("<h1>来自pleural-effusion的激活邮件，点击链接激活账号：</h1><h3><a href='http://localhost:9094/user-platform/user/active?code="+code+"'>点我激活</a>", "text/html;charset=utf-8");
            // 3.发送激活邮件
